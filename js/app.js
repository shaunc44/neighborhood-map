	...
	self.placeList().forEach(function (placeItem) {
		...
		$.ajax({
			...
			success: function (data) {
				...
				//Infowindow code is in the success function so that the error message displayed in infowindow works properly
		...
		//Event listener makes the error message on AJAX error display in the infowindow
